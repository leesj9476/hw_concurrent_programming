...
@retval	0		if ROW_FORMAT=REDUNDANT (REDUNDANT means unnecessary)*/
inline
byte
page_is_comp(const page_t* page)
{
	ut_ad(!ut_align_offset(page, UNIV_ZIP_SIZE_MIN));
	// PAGE_HEADER = 38U  PAGE_N_HEAP = 4 -> 42  0x80 = 10000000(2)
	// ==> page[] means the address of physical page and 
	// msb means ROW_FORMAT is cone of COMPACT, DYNAMIC, COMPRESSED
...
{
	// return if page(including record) is REDUNDANT
